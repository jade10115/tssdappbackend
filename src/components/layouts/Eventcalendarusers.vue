<template>
  <div class="page">
    <header class="topbar">
      ...
      <button class="btn primary" type="button" @click="openCreateModal">+ Create Event</button>
    </header>
    ...
    <!-- CREATE MODAL -->
    <div v-if="modal.open" class="calOverlay" @click.self="closeModal">
            ...
            <div class="card subtle">
              ...
              <div v-if="attendeeDropdownOpen" class="dropdown">
                <div class="dropdownSearch">
                  <input class="input" v-model="employeeSearch" placeholder="Search employee, position, division, phone..." />
                </div>
              ...
              <div v-else class="chips">
                <div class="chip" v-for="a in modal.form.attendees" :key="a.user_id">
                  <span class="chipText">{{ a.full_name }} <span v-if="a.position">({{ a.position }})</span></span>
...
async function saveEvent() {
  ...
  try {
    ...
    // ✅ SweetAlert ABOVE modal (we fixed z-index in CSS)
    await Swal.fire({
      icon: "success",
      title: "Saved!",
