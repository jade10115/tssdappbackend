    ...
    <div class="table-section">
      ...
      <div class="table-wrapper">
        <table>
          ...
          <tbody>
            <tr v-for="adl in adlDetails" :key="adl.id">
              <td class="adl-name">
                <div class="adl-cell">
...
.mini-label { color:#64748b; font-size: 12px; font-weight: 700; }
.mini-value { color:#0f172a; font-weight: 900; font-size: 13px; }
...
.total-beneficiaries .stat-icon { background: rgba(245,158,11,0.10); color: #f59e0b; }
.total-amount .stat-icon { background: rgba(16,185,129,0.10); color: #10b981; }
.remaining-balance .stat-icon { background: rgba(59,130,246,0.10); color: #3b82f6; }
.completion-rate .stat-icon { background: rgba(239,68,68,0.10); color: #ef4444; }
...
.btn-primary:hover { transform: translateY(-2px); box-shadow: 0 14px 28px rgba(37,99,235,0.22); }
...
.numeric { text-align: right; font-weight: 800; }
.actions-head { text-align: center; width: 200px; }

.adl-cell { display:flex; align-items:center; gap: 12px; }
.adl-badge {
  width: 36px;
  height: 36px;
  border-radius: 10px;
...
.adl-meta { display:flex; flex-direction: column; gap: 2px; }
.adl-title { font-weight: 900; color:#0b3a66; line-height: 1.1; }
.adl-sub { font-size: 12px; color:#64748b; font-weight: 700; }

.sponsor-name { color: #64748b; font-weight: 700; }
...
.progress-text { min-width: 52px; text-align:right; font-weight: 900; color:#334155; }
...
.btn-icon-btn svg { width: 18px; height: 18px; color: #334155; }

.btn-delete:hover { background: rgba(239,68,68,0.10); border-color: rgba(239,68,68,0.25); }
.btn-delete:hover svg { color: #b91c1c; }

.empty-state { text-align:center; padding: 40px 12px; }
.empty-content { max-width: 520px; margin: 0 auto; }

/* ---------------------------
   SweetAlert2 custom modal UI
   --------------------------- */
:global(.swal-popup) {
...
/* Modal layout */
:global(.swal-wrap) { text-align: left; }
:global(.swal-top) { padding: 6px 6px 10px; margin-bottom: 8px; }
...
:global(.swal-field.full) { grid-column: 1 / -1; }
